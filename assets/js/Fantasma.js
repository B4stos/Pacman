export default class Fantasma {
    ...
    {       
        this.sprite=scene.physics.add.sprite(position.x, position.y, 'fantasma')
            .setScale(0.9)
            .setOrigin(0.45);
    ...
    turn()
    {
        ...
        // É necessário threshold pois a altas velocidades, os sprites não encaixam nos turningPoints
